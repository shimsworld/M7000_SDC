...
#Region "Creator, Disposer And init"
    Public Sub New(ByVal model As CDevSMUCommonNode.eModel)
    ...
    Private Sub init(ByVal model As CDevSMUCommonNode.eModel)
        ...
        ucCtrlKeithley.DisplayMode = model
    End Sub
#End Region
