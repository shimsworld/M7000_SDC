...
#Region "Creator, Disposer, Init"
    ...
    Public Sub New()
        MyBase.New()
        m_MyModel = eModel.SPECTROMETER_PR655
    End Sub
...
#Region "API Functions"
    ...
    Public Overrides Function SetLens(ByVal nLensIndex As Integer) As Boolean
        If SetPR655Lens(nLensIndex) = False Then Return False
        Return True
    End Function
...
#Region "Functions"
    ...
    Public Function SetPR655Lens(ByVal nLensCode As Integer) As Boolean
    ...
    Public Function ReadData(ByVal nMode As eMeasMode, ByRef outData As tData) As Boolean
        ...
        Dim sCmd As String = sCommands(eCommands.eDownloadsDataFromThePR655) & CStr(nMode)
        Dim sRcvData As String = Nothing
