...
#Region "Creator, Disposer, Init"
    ...
    Public Sub New()
        MyBase.New()
        m_MyModel = eModel.SPECTROMETER_PR740
    End Sub
...
#Region "API Functions"
    ...
    Public Overrides Function SetLens(ByVal nLensIndex As Integer) As Boolean
        If SetPR740Lens(nLensIndex) = False Then Return False
        Return True
    End Function

    Public Overrides Function SetAperture(ByVal nAperatureIndex As Integer) As Boolean
        If SetApertures(nAperatureIndex) = False Then Return False
        Return True
    End Function
...
#Region "Functions"
    ...
    Public Function GetAccessory(ByRef sAccessory() As sLens) As Boolean
        ...
        For i = 0 To arrLineBuf.Length - 2
            arrCommaBuf = Split(arrLineBuf(i), ",", -1)

            If arrCommaBuf.Length = 1 Then
                ReDim sAccessory(arrLineBuf.Length - 3)
            Else
    ...
    Public Function SetPR740Lens(ByVal nLensCode As Integer) As Boolean
    ...
    Public Function SetApertures(ByVal nApertureCode As Integer) As Boolean
        Dim sCommand As String
        Dim sRcvData As String = Nothing
    ...
    Public Function ReadData(ByVal nMode As eMeasMode, ByRef outData As tData) As Boolean
        ...
        Dim sCmd As String = sCommands(eCommands.eDownloadsDataFromThePR740) & CStr(nMode)
        Dim sRcvData As String = Nothing
    ...
    Public Function ErrCheck(ByVal inRcv As String) As Boolean
        ...
        Try
            ...
            Select Case ErrCode
                ...
                Case -1008
                    MsgBox("Invalid Aperture index (PR-740/745 only)")
                Case -1009
