...
#Region "Defines"
    ...
    Private sMeasSpeedName() As String = New String() {"Auto", "Manual"}
...
#Region "Creator, Disposer, Init"
    Public Sub New()
        MyBase.New()
        m_MyModel = eModel.SPECTROMETER_CS1000
    End Sub
#End Region
...
#Region "Functions"
    ...
    Private Function SetSpeed(ByVal index As eMeasSpeed, ByVal nSpeedVal As Double) As Boolean
        ...
        If index = eMeasSpeed.eAuto Then
            sCommand = "MMS" & "," & "0" & "," & ""
    ...
    Public Function MeasSpectrumData() As Boolean
        Dim sCommand As String = "BDR,0," & eObserver.e2 & ",0"
        Dim sRcvData As String = ""
        Dim sMsg As String = ""
