...
#Region "Functions"
    ...
    Private Function GetValueFromUI() As Boolean
        With m_SettingInfos
            ...
            If rdoAdaptiveOn.Checked = True Then
                .ExposeTimeONOFF = 0
                .ExposeTime = 0
            Else
                .ExposeTimeONOFF = 1
                .ExposeTime = CInt(txtExposetime.Text)
            End If
    ...
    Private Sub SetValueToUI()
        With m_SettingInfos
            Try
                ...
                If .ExposeTimeONOFF = 1 Then
                    rdoAdaptiveOff.Checked = True
                    txtExposetime.Text = CStr(.ExposeTime)
                    txtExposetime.Enabled = True
                Else
                    rdoAdaptiveOn.Checked = True
                    txtExposetime.Text = 0
                    txtExposetime.Enabled = False
                End If
...
#End Region
    ...
    Private Sub rdoAdaptiveOn_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles rdoAdaptiveOn.CheckedChanged, rdoAdaptiveOff.CheckedChanged
        If rdoAdaptiveOff.Checked = True Then
            txtExposetime.Enabled = True
        Else
            txtExposetime.Enabled = False
        End If
