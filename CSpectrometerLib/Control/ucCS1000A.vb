...
#Region "Defines"
    ...
    Public Event evSetAperture(ByVal mode As CDevCS1000A.eAperture)
    Public Event evSetMeasuringSpeed(ByVal mode As CDevCS1000A.eMeasSpeed, ByVal value As Double)
#End Region
