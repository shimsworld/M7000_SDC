...
#Region "Defines"
    ...
    Public Event evSetAperture(ByVal mode As CDevSR_3AR.eMeasField)
    Public Event evSetMeasuringSpeed(ByVal mode As CDevSR_3AR.eMeasSpeed)
