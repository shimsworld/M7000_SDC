...
Public Class ucK24XXConfig

#Region "Define"
    Dim sCommType() As String = New String() {"TCP/IP", "UDP", "Serial", "GPIB"}

    Dim sConfigData() As sK24XXConfig
...
#Region "Property"
    ...
    Property Setting() As sK24XXConfig()
        Get
            Return sConfigData
        End Get
        Set(ByVal value As sK24XXConfig())
...
#End Region
    ...
    Private Sub btnADD_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnADD.Click
        Dim m_K24XXConfig As sK24XXConfig = Nothing

        GetSettingForm(m_K24XXConfig)

        ConfigDataUpdate(m_K24XXConfig)

        ConfigListUP(m_K24XXConfig)
    End Sub
    ...
    Private Sub ConfigDataUpdate(ByVal ConfigData As sK24XXConfig)

        Dim ConfigDataBuff(ConfigList.GetListItemCount) As sK24XXConfig
    ...
    Private Sub ConfigListDataDelete(ByVal DeleteNo As Integer)
        ...
        If DeleteNo <> 0 Then
            Dim ConfigDataBuff(sConfigData.Length - 2) As sK24XXConfig
    ...
    Private Sub LoadDataSetting(ByVal ConfigData As sK24XXConfig)
    ...
    Private Function GetSettingForm(ByRef ConfigData As sK24XXConfig) As Boolean
    ...
    Private Sub ConfigListUP(ByVal ConfigData As sK24XXConfig)
        Dim sData(3) As String
