...
Public Class frmK23XControl
    ...
    Public Sub init()
        ...
        ucKeithleyCommon.DisplayMode = CDevSMUCommonNode.eModel.kEITHLEY_K238
    ...
    Private Sub btnSetBias_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetBias.Click
        'm_Main.cIVLSMU(m_nSelDevNum).mySMU.SetKeithleyInfos = ucKeithleyCommon.Settings
    ...
    Private Sub btnCellOff_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCellOff.Click
        If m_Main.cIVLSMU(m_nSelDevNum).mySMU.FinalizeSweep = False Then
    ...
    Private Sub btnMeas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMeas.Click
        ...
        'm_Main.cK23X(m_nSelDevNum).SetKeithleyInfos = ucKeithleyCommon.Settings
        If m_Main.cIVLSMU(m_nSelDevNum).mySMU.InitializeSweep(ucKeithleyCommon.Settings) = False Then Exit Sub
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        If m_Main.cIVLSMU(m_nSelDevNum).mySMU.Test = True Then
